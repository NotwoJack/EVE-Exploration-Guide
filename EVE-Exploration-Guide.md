...
8.	建立一个舰队![logo](https://wiki.eveuniversity.org/images/e/e3/Fleet.png ':size=WIDTHxHEIGHT') ，就能使用数字键直接标记箱子，极大提高效率
...
上图是一个破解小游戏的图解，Conherence 是你的血量，Strength是你的攻击，基于章节2的建议配置，你目前应该有70血量25攻击，除了最高难度的红核心，其他难度的破解应该都比较容易。
...
| System Core        	| ![logo](https://wiki.eveuniversity.org/images/1/1c/Core_node_hard_red.png)| 你的目标，系统核心的颜色表明破解难度，<br> 难度影响部分节点的血量和攻击。<br> 绿：简单 橙：中等 红：困难                           	|
...
**假隐跳 by 784 fvtr**
 ...
 ![logo](https://notwojack.github.io/EVE-Exploration-Guide/image/6.2-1.png ':size=50%')
...
![logo](https://notwojack.github.io/EVE-Exploration-Guide/image/6.2-3.png ':size=40%')
